...
#
# Off-site backup of the Vancouver Island world (+ admin/permitted/banned
# lists) to Azure Blob Storage, using the VM's system-assigned managed
...
OFFSITE_ACCOUNT="stvalheimz09j56"
...
lists_tgz_name="vancouver-island-lists-$TS.tgz"
