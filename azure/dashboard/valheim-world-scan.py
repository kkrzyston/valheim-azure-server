...
File format notes (reverse engineered on this deployment's world, save version 41):
...
# WORLD_NAME comes from /etc/valheim-server.env (see valheim-status.service's EnvironmentFile=).
