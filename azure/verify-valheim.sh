...
SEED="uEA2lEA5YC"
W="/home/valheim/data/worlds_local/Vancouver Island"
...
echo "-- world dirs (want 'Vancouver Island' plus its _backup_ dirs only):"; ls -1 /home/valheim/data/worlds_local
